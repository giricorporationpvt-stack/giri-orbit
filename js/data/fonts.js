...
export const WORLD_FONTS_CATALOG = [
  // --------------------------------------------------------------------------
  // 1. STANDARD OFFICE CLASSICS (Calibri is #1 Default)
  // --------------------------------------------------------------------------
  { name: 'Calibri', family: "Calibri, 'Segoe UI', Arial, sans-serif", category: 'Standard Classics', isDefault: true },
  { name: 'Calibri Light', family: "'Calibri Light', Calibri, sans-serif", category: 'Standard Classics' },
  { name: 'Aptos', family: "Aptos, 'Segoe UI', Arial, sans-serif", category: 'Standard Classics' },
  { name: 'Aptos Display', family: "'Aptos Display', Aptos, sans-serif", category: 'Standard Classics' },
  { name: 'Segoe UI', family: "'Segoe UI', -apple-system, BlinkMacSystemFont, sans-serif", category: 'Standard Classics' },
  { name: 'Segoe UI Variable', family: "'Segoe UI Variable', 'Segoe UI', sans-serif", category: 'Standard Classics' },
  { name: 'Arial', family: "Arial, Helvetica, sans-serif", category: 'Standard Classics' },
  { name: 'Arial Black', family: "'Arial Black', Arial, sans-serif", category: 'Standard Classics' },
  { name: 'Times New Roman', family: "'Times New Roman', Times, serif", category: 'Standard Classics' },
  { name: 'Georgia', family: "Georgia, 'Times New Roman', serif", category: 'Standard Classics' },
  { name: 'Garamond', family: "Garamond, 'EB Garamond', Georgia, serif", category: 'Standard Classics' },
  { name: 'Cambria', family: "Cambria, Georgia, serif", category: 'Standard Classics' },
  { name: 'Constantia', family: "Constantia, Georgia, serif", category: 'Standard Classics' },
  { name: 'Corbel', family: "Corbel, 'Segoe UI', sans-serif", category: 'Standard Classics' },
  { name: 'Candara', family: "Candara, 'Segoe UI', sans-serif", category: 'Standard Classics' },
  { name: 'Trebuchet MS', family: "'Trebuchet MS', Helvetica, sans-serif", category: 'Standard Classics' },
  { name: 'Tahoma', family: "Tahoma, Verdana, sans-serif", category: 'Standard Classics' },
  { name: 'Verdana', family: "Verdana, Geneva, sans-serif", category: 'Standard Classics' },
  { name: 'Comic Sans MS', family: "'Comic Sans MS', 'Comic Sans', cursive", category: 'Standard Classics' },
  { name: 'Impact', family: "Impact, Charcoal, sans-serif", category: 'Standard Classics' },
  { name: 'Palatino Linotype', family: "'Palatino Linotype', 'Book Antiqua', Palatino, serif", category: 'Standard Classics' },
  { name: 'Book Antiqua', family: "'Book Antiqua', Palatino, serif", category: 'Standard Classics' },
  { name: 'Century Gothic', family: "'Century Gothic', Futura, sans-serif", category: 'Standard Classics' },
  { name: 'Franklin Gothic Medium', family: "'Franklin Gothic Medium', Arial, sans-serif", category: 'Standard Classics' },
  { name: 'Sitka Text', family: "'Sitka Text', Georgia, serif", category: 'Standard Classics' },
  { name: 'Baskerville', family: "Baskerville, 'Times New Roman', serif", category: 'Standard Classics' },
